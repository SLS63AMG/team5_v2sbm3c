...
CREATE TABLE contents (
    ...
    recom NUMBER(7) DEFAULT 0 NOT NULL, -- 추천수
    ...
    size1 NUMBER(10) DEFAULT 0 NOT NULL, -- 파일 크기
    price NUMBER(10) DEFAULT 0 NOT NULL, -- 정가
    dc NUMBER(10) DEFAULT 0 NOT NULL,    -- 할인률
    saleprice NUMBER(10) DEFAULT 0 NOT NULL, -- 판매가
    salecnt NUMBER(10) DEFAULT 0 NOT NULL,   -- 재고 수량
