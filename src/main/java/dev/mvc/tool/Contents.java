...
public class Contents {
     ...
     * 답변 이미지 경로
     */
    public static String getUploadDir_answer() {
        String osName = System.getProperty("os.name").toLowerCase();
        String path = "";

        if (osName.contains("win")) { // Windows
            path = "C:\\kd\\deploy\\team5\\answer\\storage\\";
        } else if (osName.contains("mac")) { // MacOS
            path = "/Users/yourusername/deploy/team5/answer/storage/";
        } else { // Linux
            path = "/home/ubuntu/deploy/team5/answer/storage/";
        }
